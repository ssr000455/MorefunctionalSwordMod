...
import com.qidai.morefunctionalswordmod.item.AntiCheatItem;
...
public class ModRegistry {
    ...
    // ========== 反作弊器 ==========
    public static final Item ANTI_CHEAT = registerItem("anti_cheat", new AntiCheatItem(new FabricItemSettings().maxCount(1).fireproof()));
